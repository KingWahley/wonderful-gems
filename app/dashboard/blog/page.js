          ...
          <div className="bg-white border border-brand-border/70 rounded-2xl shadow-xs p-6">
            ...
            {loading ? (
              <div className="py-24 flex flex-col items-center justify-center gap-4 font-sans">
                ...
                <p className="text-brand-muted text-[11px] font-bold tracking-widest uppercase animate-pulse">Gathering stories...</p>
              </div>
            ) : filtered.length === 0 ? (
                ...
                <table className="w-full text-left text-xs whitespace-nowrap table-auto border-collapse">
                  ...
                  <tbody className="divide-y divide-brand-border/40">
                    {displayedBlogs.map((blog) => {
                      ...
                      const isDraft = blog.status !== "Published" && blog.status !== "Review" && blog.status !== "In Review";

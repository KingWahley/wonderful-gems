      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-2 text-[10px] tracking-[0.2em] font-bold text-charcoal-700 uppercase">
            <Link
              href="/mini-guides"
              className="hover:text-[#DCAE1D] transition-colors"
            >
              DESTINATIONS
            </Link>
            ...
            <span className="text-charcoal-900">
              {details.routeFlow
                ? details.routeFlow
                    ...
                    .replace(/->/g, " • ")
                    .replace(/→/g, " • ")
                : guide.title.split(" ").slice(0, 3).join(" • ").toUpperCase()}
            </span>
          </div>
        </div>
              ...
              <>
                    ...
                    <div className="bg-white border-2 border-charcoal-900 rounded-[32px] p-8 md:p-10 transform -translate-x-2 -translate-y-2 transition-all duration-300 hover:-translate-x-1 hover:-translate-y-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                        {details.sights && details.sights.length > 0 && (
                          <a
                            href="#top-sights"
                            className="flex items-center gap-4 pb-4 border-b border-dashed border-charcoal-900/10 hover:text-[#DCAE1D] transition-colors group"
                          >
                            <span className="font-serif text-[18px] font-bold text-[#E9C46A] w-6">
                              01
                            </span>
                            <span className="text-[20px] leading-none">📍</span>
                            <span className="font-serif text-[17px] font-bold text-charcoal-900 group-hover:text-[#DCAE1D] transition-colors">
                              Top sights
                            </span>
                          </a>
                        )}
                  ...
                  <div id="top-sights" className="mb-20 scroll-mt-24">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 mb-8">
                      {details.sights.map((sight, idx) => {
                        ...
                        return (
                          ...
                          >
                            <div
                              className={`w-14 md:w-16 flex-shrink-0 flex items-center justify-center font-serif font-bold text-lg md:text-xl text-charcoal-900 border-r-2 border-charcoal-900 ${colorClass}`}
                            >
                              {sight.num}
                            </div>
                    ...
                    <div className="flex justify-center mt-12 mb-16">
                      <div className="bg-white border-2 border-dashed border-charcoal-300 p-4 rounded-[20px] text-center w-[120px] shadow-sm flex flex-col justify-center items-center">
                        <span className="font-serif text-[18px] font-bold text-charcoal-400 leading-none">
                          photo
                        </span>
                        <span className="text-[7px] font-bold tracking-widest text-charcoal-400 uppercase mt-1 leading-none">
                          TOP SIGHTS
                        </span>
                      </div>
                    </div>
                ...
                {details.stay &&
                  (details.stay.budget?.length > 0 ||
                    ...
                    <div id="where-to-stay" className="mb-20 scroll-mt-24">
                      ...
                      <p className="text-charcoal-500/80 text-sm md:text-base leading-relaxed mb-10 max-w-xl font-normal font-sans">
                        Picks across three price tiers. All hand-chosen — none
                        of these are generic chains.
                      </p>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="bg-white border-2 border-charcoal-900 rounded-[28px] shadow-[4px_4px_0px_0px_#2B2A27] flex flex-col overflow-hidden">
                          <div className="bg-[#E9C46A] border-b-2 border-charcoal-900 p-5 text-center">
                            <span className="text-[10px] font-bold tracking-[0.25em] text-charcoal-900 uppercase">
                              BUDGET
                            </span>
                          </div>
                          <div className="p-6 flex-1 flex flex-col justify-start space-y-6">
                            {details.stay.budget.map((hotel, idx) => (
                              <div key={idx} className="flex flex-col">
                                {idx > 0 && (
                                  <div className="border-t border-cream-200/60 my-4" />
                                )}
                                <span className="text-[15px] font-bold text-charcoal-900 uppercase tracking-wide leading-tight">
                                  {hotel.name}
                                </span>
                                <span className="text-xs text-charcoal-500/80 mt-1 font-light leading-relaxed">
                                  {hotel.desc}
                                </span>
                              </div>
                            ))}
                ...
                {details.activities && details.activities.length > 0 && (
                  <div id="activities" className="mb-20 scroll-mt-24">
                    ...
                    <p className="text-charcoal-500/80 text-sm md:text-base leading-relaxed mb-10 max-w-xl font-normal font-sans">
                      Beyond the sights — the experiences worth booking ahead of
                      time.
                    </p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                      {details.activities.map((act, idx) => {
                        ...
                        const colorClass = pillColors[idx % pillColors.length];
                        const displayNum = act.num.startsWith("#")
                          ? act.num
                          : `#${parseInt(act.num, 10)}`;
                        return (
                          <div
                          ...
                          >
                            <div className="absolute top-6 right-6">
                              <Sparkle
                                size={28}
                                className="text-charcoal-900/15 fill-charcoal-900/15 transition-transform duration-500 group-hover:rotate-45"
                              />
                            </div>
                            <div>
                    ...
                    <div className="flex justify-center mt-12 mb-16">
                      <div className="bg-white border-2 border-dashed border-charcoal-300 p-4 rounded-[20px] text-center w-[120px] shadow-sm flex flex-col justify-center items-center">
                        ...
                        <span className="text-[7px] font-bold tracking-[0.2em] text-charcoal-400 uppercase mt-1 leading-none">
                          THINGS TO DO
                        </span>
                      </div>
                    </div>
                ...
                {details.eat && details.eat.length > 0 && (
                  <div id="eat-drink" className="mb-20 scroll-mt-24">
                    ...
                    <p className="text-charcoal-700 text-sm md:text-base leading-relaxed mb-10 max-w-2xl font-light">
                      The flavours that define this place — order these without
                      overthinking.
                    </p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                      {details.eat.map((dish, idx) => {
                        ...
                        return (
                          <div
                            key={idx}
                            className="bg-white rounded-[20px] border border-charcoal-900/8 p-5 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow duration-200"
                          >
                            <div
                              className={`w-12 h-12 rounded-full ${iconBgs[idx % iconBgs.length]} flex items-center justify-center flex-shrink-0`}
                            >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="bg-white border-2 border-charcoal-900 rounded-[28px] shadow-[4px_4px_0px_0px_#2B2A27] flex flex-col overflow-hidden">
                          ...
                          <div className="p-6 flex-1 flex flex-col justify-start space-y-6">
                            ...
                            {details.restaurants.budget.length === 0 && (
                              <span className="text-xs text-charcoal-400 italic">
                                No budget restaurants listed yet.
                              </span>
                            )}
                          </div>
                        </div>
                        ...
                        <div className="bg-white border-2 border-charcoal-900 rounded-[28px] shadow-[4px_4px_0px_0px_#2B2A27] flex flex-col overflow-hidden">
                          ...
                          <div className="p-6 flex-1 flex flex-col justify-start space-y-6">
                            ...
                            {details.restaurants.mid.length === 0 && (
                              <span className="text-xs text-charcoal-400 italic">
                                No mid-range restaurants listed yet.
                              </span>
                            )}
                          </div>
                        </div>
                        ...
                        <div className="bg-white border-2 border-charcoal-900 rounded-[28px] shadow-[4px_4px_0px_0px_#2B2A27] flex flex-col overflow-hidden">
                          ...
                          <div className="p-6 flex-1 flex flex-col justify-start space-y-6">
                            ...
                            {details.restaurants.splurge.length === 0 && (
                              <span className="text-xs text-charcoal-400 italic">
                                No fine dining restaurants listed yet.
                              </span>
                            )}
                          </div>
                        </div>
                ...
                {details.dayTrips && details.dayTrips.length > 0 && (
                  <div id="day-trips" className="mb-24 scroll-mt-24">
                    ...
                    <p className="text-charcoal-700 text-sm md:text-base leading-relaxed mb-10 max-w-2xl font-light">
                      Worth the early start — each is reachable as a single-day
                      excursion.
                    </p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                      {details.dayTrips.map((trip) => (
                        ...
                        >
                          ...
                          <div
                            className={`${trip.solidBg} flex items-center justify-center w-[72px] flex-shrink-0`}
                          >
                    ...
                    return (
                      <div key={idx} className="relative group">
                        ...
                        >
                          ...
                          <div
                            className={`px-8 py-7 relative ${c.headerBg} flex items-center justify-between text-white border-b-2 border-charcoal-900`}
                          >
                            <div className="relative z-10 max-w-[70%]">
                              <span className="text-[10px] md:text-[11px] font-bold tracking-[0.25em] text-white/90 uppercase block mb-1">
                                DAY {day.dayNum}{" "}
                                {day.city && `— ${day.city.toUpperCase()}`}
                              </span>
                                  ...
                                  <div className="space-y-6">
                                    ...
                                    <div className="space-y-5">
                                      {thingsToDo.map((todo, tIdx) => (
                                        ...
                                        >
                                          <div
                                            className={`w-8 h-8 rounded-full flex-shrink-0 flex items-center justify-center font-serif font-bold text-xs shadow-sm border border-charcoal-900/10 ${c.badgeBg}`}
                                          >
                                            {tIdx + 1}
                                          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <h3 className="font-serif text-2xl md:text-3xl font-bold leading-tight max-w-sm mt-4">
                  Read the best blog posts from {details.country}{" "}
              ...
              >
                <span className="text-[9px] font-bold tracking-[0.2em] text-charcoal-950/60 uppercase">
                  CUSTOM PLANNING
                </span>
                <h3 className="font-serif text-2xl md:text-3xl font-bold leading-tight max-w-sm mt-4">
                  Let me plan your {guide.title.split(" ")[0]} itinerary{" "}
                  <span className="inline-block transition-transform group-hover:translate-x-1 ml-1">
                    →
                  </span>
                </h3>
